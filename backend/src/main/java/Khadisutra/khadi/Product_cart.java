...
public class Product_cart {
	...
	public Product_cart(String main_category, String p_id, String p_name, int p_price, int p_discount,
			int p_final_price, String p_display_photo, String p_category_id, boolean p_discount_available,
			boolean p_show_product) {
		super();
		this.main_category = main_category;
		this.p_id = p_id;
		this.p_name = p_name;
